...
A blazingly fast and 90% spec-compliant Rust reimplementation of the npm package [`json-server v1`](https://github.com/typicode/json-server). Built on [Tokio](https://tokio.rs/) and [Axum](https://github.com/tokio-rs/axum).
